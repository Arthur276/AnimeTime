...
class Saison():
    ...
    def afficher_episodes_saison(self):
        ...
        return dict_anime[animedata["dict_episodes_clé"]][str(self.numero_saison)]
...
class Anime():
    ...
    def afficher_saisons_episodes(self):
        ...
        return dict_anime[animedata["dict_episodes_clé"]]
    ...
    with open(animedata[fichier_cible],"r",encoding ="utf-8") as animedata_json:
        ...
        for element in anime_dict.values():
            if element["type"] == "anime" and nom_anime == element[animedata["dict_nom_anime_clé"]]:
                ...
                anime_id_memoire = Anime.instances_anime[nom_anime]
